  ...
  <div class="col-lg-6">
    <div class="learning backgroundGrey curvedCorner padAll bottomBorderRandom shadow margin-bot">
      ...
      <ul class="skillList">
        ...
        <li data-toggle="tooltip" data-placement="bottom" title="<?php the_sub_field('box_two_fa_icon_tool_tip'); ?>"><a href="<?php the_sub_field('box_two_fa_icon_link'); ?>"><i class="<?php the_sub_field('box_two_fa_icon'); ?>"></i></a></li>
      <?php endwhile; endif; ?>
      </ul>
    </div>
  </div>
